//~~tv:17003.20150512
//~~tc: Update to load tag script on window.onload event
//      Fix to IE8 issue

//tealium universal tag - utag.sender.17003 ut4.0.202010282035, Copyright 2020 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {};
    ...
    u.send = function (a, b) {
      if (u.ev[a] || u.ev.all !== undefined) {
        ...
        u.data = {
          ...
          "kvp_delim" : "=",
          "samplerate" : "100",
          "siteinterceptid" : "ZN_doHhT6xbShXrzDf",
          "usezones" : "yes",
          "base_url" : "//zndohht6xbshxrzdf-digikey.siteintercept.qualtrics.com/WRSiteInterceptEngine/?"
        };
        ...
        //new behaviour in order to fire Tag at onLoad
        var go = function () {
          var e, s, scr;
