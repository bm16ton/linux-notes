...
//tealium universal tag - utag.sender.2063 ut4.0.202010282035, Copyright 2020 Tealium.com Inc. All Rights Reserved.
try {
  (function (id, loader) {
    var u = {"id" : id};
    ...
    u.std_params = {
      ...
      u.map={"bing_id":"tagid","b_page_type:confirmation":"purchase","b_page_type:page_view":"page_view","b_page_type:checkout":"begin_checkout","bing_part_ids":"product_id"};
  u.extend=[function(a,b){ try{ if(1){
if (a === 'view') {
    var page_type_sub_type = b.page_type + "-" + b.page_sub_type;
    switch (page_type_sub_type) {
    case "HP-HP":
        b.b_page_type = 'page_view';
        break;
    case "PS-PD":
        b.b_page_type = "product";
        b.bing_part_ids = [];
        b.bing_part_ids.push(b.part_id);
        utag.postBingProductData('product',b,b.bing_part_ids);
        break;
    case "SC-CO":
        b.b_page_type = "cart";
        break;
    ...
    u.loader_cb = function (a, b, c) {
      ...
      utag.DB("send:344:CALLBACK:COMPLETE");
    };
    // End Loader Callback
