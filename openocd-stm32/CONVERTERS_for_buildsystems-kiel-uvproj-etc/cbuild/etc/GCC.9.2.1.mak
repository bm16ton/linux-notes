...
#
#   - Applies to toolchain: ARMCC GCC 9.2.1
...
CC_SYS_INC_PATH:=\
$(TOOLCHAIN_ROOT_WS)/../lib/gcc/arm-none-eabi/9.2.1/include\
$(TOOLCHAIN_ROOT_WS)/../lib/gcc/arm-none-eabi/9.2.1/include-fixed\
...
CXX_SYS_INC_PATH:=\
$(TOOLCHAIN_ROOT_WS)/../arm-none-eabi/include/c++/9.2.1\
$(TOOLCHAIN_ROOT_WS)/../arm-none-eabi/include/c++/9.2.1/arm-none-eabi\
$(TOOLCHAIN_ROOT_WS)/../arm-none-eabi/include/c++/9.2.1/backward\
$(CC_SYS_INC_PATH)
