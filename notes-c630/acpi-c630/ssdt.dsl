 ...
 *
 * Disassembly of ssdt.dat, Wed Dec  9 19:30:54 2020
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x0000055C (1372)
 *     Revision         0x02
 *     Checksum         0xAA
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "CB-01   "
...
DefinitionBlock ("", "SSDT", 2, "LENOVO", "CB-01   ", 0x00000001)
{
    ...
    External (_SB_.I2C2.ECR0, BuffFieldObj)
    External (_SB_.I2C2.ECRW, MethodObj)    // 5 Arguments
    ...
    Scope (\_SB)
    {
        ...
        Device (UBTC)
        {
            ...
            {
                \_SB.I2C2.ECRW (0xB3, 0xF2, 0x20, Zero, Zero)
                VER1 = \_SB.I2C2.ECR0 /* External reference */
                \_SB.I2C2.ECRW (0xB3, 0xF2, 0x21, Zero, Zero)
                VER2 = \_SB.I2C2.ECR0 /* External reference */
                Return (0x0F)
            }
